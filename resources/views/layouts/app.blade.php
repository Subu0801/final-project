        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                            <a class="nav-link" href="#">Client Account</a>
                     </li>
                    <li class="nav-item dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="#">Hotels Services</a>
                        {{--  <div class="dropdown-divider"></div>  --}}
                        <a class="dropdown-item" href="#">Videography</a>
                        <a class="dropdown-item" href="#">Photography</a>
                        <a class="dropdown-item" href="#">Wedding Deco</a>
                      </div>
                    </li>
                    <li class="nav-item">
                            <a class="nav-link" href="#">Online Calendar Services</a>
                    </li>
                    <li class="nav-item">
                            <a class="nav-link" href="#">Online Help Chatting & Wedd Idea</a>
                    </li>
